-- Recalculate final scores as soon as any fixture finishes. Remaining scheduled/live fixtures keep the gameweek open.
...
begin
  ...
  loop
    ...
    v_status := case
      ...
      when coalesce((v_fixture->>'finished')::boolean, false)
        or coalesce((v_fixture->>'finished_provisional')::boolean, false) then 'finished'
