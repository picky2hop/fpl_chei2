...
import type { FantasyEntryCurrentSquad, FantasySquadPlayer } from "@/lib/fantasy/types";
import { playerDisplayPoints, playerPresentation } from "@/lib/fantasy/player-presentation";
import { visiblePlayerStats, type PlayerStatsCategory, type PlayerStatsPositionFilter } from "@/lib/fantasy/player-stats-view";
import { squadRows } from "@/lib/fantasy/squad-layout";
import { shareFantasyLeaderboard, shareFantasyPlayerStats, shareFantasySquad, type FantasyShareStatus } from "@/lib/fantasy/fantasy-share-actions";
...
function PlayerStats({ data }: { data: FantasyLeagueDashboardResponse }) {
  ...
  const visible = visiblePlayerStats(data.playerStats, category, position);
  const popular = [{ label: "กัปตันยอดนิยม", entry: data.playerStats.globalCaptain }, { label: "รองกัปตันยอดนิยม", entry: data.playerStats.globalViceCaptain }];
