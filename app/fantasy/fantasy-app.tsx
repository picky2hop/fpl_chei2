...
import { playerDisplayPoints, playerHighlight, playerPresentation } from "@/lib/fantasy/player-presentation";
...
function LegacyPlayerStats({ data }: { data: FantasyLeagueDashboardResponse }) {
