...
const pageOne = {
  ...
  standings: {
    has_next: true,
    results: [
      { id: 1, entry: 101, entry_name: "Team One", player_name: "Manager One", rank: 1 },
      { id: 2, entry: 102, entry_name: "Team Two", player_name: "Manager Two", rank: 2 },
    ],
  },
};
...
const pageTwo = {
  ...
  standings: {
    has_next: false,
    results: [
      { id: 3, entry: 101, entry_name: "Team One", player_name: "Manager One", rank: 1 },
      { id: 4, entry: 103, entry_name: "Team Three", player_name: "Manager Three", rank: 3 },
    ],
  },
};
...
test("loads every FPL league standings page and preserves source rank", async () => {
  ...
  assert.deepEqual(await provider.getLeagueMembers(819498), [
    ...
    { entryId: 101, teamName: "Team One", managerName: "Manager One", rank: 1 },
    { entryId: 103, teamName: "Team Three", managerName: "Manager Three", rank: 3 },
  ]);
});
